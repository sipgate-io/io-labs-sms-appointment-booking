...
function parse(smsBody) {
    ...
    if(!isValidDate(date)) {
        throw Error('The input for the date could not be parsed, please check your input.');
    } 
    ...
    if(hour > 15 || hour < 8) {
        throw Error('You can only book an appointment between 8:00 AM and 3:00 PM.');
    }
